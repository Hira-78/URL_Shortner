...
app.config['SECRET_KEY'] = os.environ.get("MY_SECRET_KEY") or 'MySecretKeyIsNothing..'
...
class SignUp_Form(FlaskForm):
    ...
    username = StringField(validators=[InputRequired(), Length(min=4, max=25)],
                           render_kw={'placeholder': 'Username', "class": "input_field"})
    password = PasswordField(validators=[InputRequired(), Length(min=5, max=20)],
                             render_kw={'placeholder': 'Password', "class": "input_field"})
